...
export { TeamCardComponent as TeamCard } from "./TeamCard/team-card.component";
export { CallCardComponent as CallCard } from "./CallCard/call-card.component";
export { FormCardComponent as FormCard } from "./FormCard/form-card.component";
