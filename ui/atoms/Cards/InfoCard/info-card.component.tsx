...
export const InfoCardComponent: React.FC<InfoCardProps> = ({ item }) => {
  ...
  return (
    <div className="mb-15 lg:mt-0 flex flex-col items-center text-center bg-white border border-secondary rounded-2xl p-6 pt-0 shadow-md hover:shadow-lg transition-shadow duration-300">
